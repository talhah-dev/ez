...
const Navbar = () => {
    return (
        <div className="max-w-7xl p-5 w-full mx-auto flex items-center justify-between h-24 text-white">
            <Link href={"/"}>
            ...
            <button className="px-6 py-3 md:block hidden cursor-pointer transition-all duration-500 hover:opacity-80 rounded-full bg-[#191a20] font-medium">Get In Touch</button>
