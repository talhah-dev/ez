            ...
            <div className="w-full flex ">
                ...
                <div className="lg:max-w-1/2 relative w-full bg-[#e5e5e6] min-h-screen flex items-center justify-center p-5">
                    ...
                    <div className="text-center max-w-sm w-full">
                        ...
                        <p className="text-zinc-800 mt-1">Enter your email below to create your account</p>
                        <input type="email" placeholder="name@gmail.com" className="border placeholder:text-sm outline-zinc-500 mt-5 rounded-lg border-zinc-400 w-full px-3 py-2" />
